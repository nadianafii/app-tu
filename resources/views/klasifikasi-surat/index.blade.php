...
@section('content')
    ...
    <br>
    <a href="{{ route('klasifikasi-surat.create') }}" class="btn btn-success mb-4">Tambah</a>
        ...
        <tbody>
            ...
            @foreach ($surat as $item)
                <tr>
                    ...
                    <td class="d-flex">
                        <a href="{{ route('klasifikasi-surat.edit', $item['id']) }}" class="btn btn-success">Edit</a>
                    ...
                    <div class="modal-dialog">
                      <div class="modal-content">
                        ...
                        <div class="modal-body">
                          <p class="font-xl">
                            Apakah anda yakin untuk menghapus data klasifikasi surat?
                          </p>
                        </div>
                        <div class="modal-footer">
                          <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Tidak</button>
                          <form action="{{ route('klasifikasi-surat.delete', $item->id) }}" method="POST">
                            @csrf
                            @method('delete')
