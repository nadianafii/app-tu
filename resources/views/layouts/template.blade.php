        ...
        <div class="sidebar p-4 bg-primary" id="sidebar">
            ...
            <li>
                ...
                <ul class="text-with dropdown-menu bg-white">
                  <li><a href="{{ route('staff.index') }}"class="dropdown-item">Data Staff Tata Usaha</a></li>
                  <li><a href="{{ route('guru.index') }}" class="dropdown-item">Data Guru</a></li>
                </ul>
            </li>
            <li>
                <a class="btn btn-primary dropdown-toggle" type="button" data-bs-toggle="dropdown">
                ...
                <ul class="text-with dropdown-menu bg-white">
                    <li><a class="dropdown-item" href="{{ route('klasifikasi-surat.index') }}">Data Klasifikasi Surat</a></li>
            ...
            <li>
                ...
                <ul class="text-with dropdown-menu bg-white">
                    <li><a class="dropdown-item" href="{{ route('">Logout</a></li>
            {{-- @if (Auth::check()) --}}
            {{-- <li>
                <a class="text-white" href="">
                    <i class="bi bi-house mr-2"></i>
