...
class LetterTypeController extends Controller
{
    ...
    {
            $surat = letter_type::withCount('letter')->get();
            return view('klasifikasi-surat.index', compact('surat'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('klasifikasi-surat.index')->with('success', 'Berhasil Menambahkan data Surat!');
    }
